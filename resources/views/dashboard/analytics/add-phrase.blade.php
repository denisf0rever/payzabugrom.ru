    ...
    <div class="wrapper__wrapper container">
      ...
      <main class="wrapper__main main">
        <div class="main__wrapper">
          <h1 class="main__title">Редактирование фразы для статьи {{ $article->h1 }}</h1>
          <section class="main__form form">
            <div class="form__wrapper">
              <form action="{{ route('dashboard.analytics.phrase.create') }}" method="post" class="form__inner-form">
                @csrf
